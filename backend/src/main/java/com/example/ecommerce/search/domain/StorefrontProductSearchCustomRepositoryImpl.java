...
public class StorefrontProductSearchCustomRepositoryImpl implements StorefrontProductSearchCustomRepository {
    ...
    public Page<StorefrontProductSearchEntity> searchVisibleProducts(
        ...
        query.select(root)
            .where(predicates(criteriaBuilder, root, keyword, categoryId, minPrice, maxPrice).toArray(Predicate[]::new))
        ...
        countQuery.select(criteriaBuilder.count(countRoot))
            .where(predicates(criteriaBuilder, countRoot, keyword, categoryId, minPrice, maxPrice).toArray(Predicate[]::new));
